...
# SCPN MIF Liner Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-MIF-LINER-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_mif_liner_core.observability.CATALOGUE_BINDING`.
    plan_identifier
