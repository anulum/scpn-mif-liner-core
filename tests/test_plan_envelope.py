...
# SCPN MIF Liner Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "fc3ac9f1bd8531fcb5468b064dd278e1e995daf6deb053f1933493c2b1d4d102"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-MIF-LINER-CORE"
    assert NON_CLAIMS == (
