...
# SCPN MIF Liner Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_mif_liner_core/__init__.py",
    "src/scpn_mif_liner_core/configuration.py",
    "src/scpn_mif_liner_core/errors.py",
    "src/scpn_mif_liner_core/observability.py",
    "src/scpn_mif_liner_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_mif_liner_core/parameters.py",
    "src/scpn_mif_liner_core/physics/__init__.py",
    "src/scpn_mif_liner_core/physics/implosion.py",
    "src/scpn_mif_liner_core/physics/compression.py",
    "src/scpn_mif_liner_core/physics/level0.py",
    "src/scpn_mif_liner_core/geometry/__init__.py",
    "src/scpn_mif_liner_core/geometry/device.py",
    "src/scpn_mif_liner_core/geometry/model.py",
    "src/scpn_mif_liner_core/geometry/cad.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-MIF-LINER-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_mif_liner_core import OWNED_CONFIGURATIONS, RegistryBinding
...
def test_typed_package_marker_exists() -> None:
    ...
    assert (REPO / "src" / "scpn_mif_liner_core" / "py.typed").is_file()
