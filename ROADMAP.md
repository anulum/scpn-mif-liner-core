...
1. **Device configuration model** — typed configuration policy for
   material-liner MIF (solid-pusher and rotating-liquid classes, drive
   synchronisation contracts, interface budgets, repetition facets), with
   evidence-maturity target `computational_prototype`.
2. **Diagnostic and clock semantics** — declared synchronisation, liner,
